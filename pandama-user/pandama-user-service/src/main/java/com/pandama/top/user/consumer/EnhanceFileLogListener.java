...
@RocketMQMessageListener(
        consumerGroup = "file_log_consumer_group",
        topic = "file_log_topic",
        selectorExpression = "*",
        consumeThreadNumber = 5)
public class EnhanceFileLogListener extends EnhanceMessageHandler<LogDTO> implements RocketMQListener<LogDTO> {
