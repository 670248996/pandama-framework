 ...
 *
 * @author 王强
 * @date 2023-07-08 15:41:18
 */
@Slf4j
@Component
@RequiredArgsConstructor(onConstructor_ = {@Autowired})
@RocketMQMessageListener(
        consumerGroup = "login_log_consumer_group",
        topic = "login_log_topic",
        selectorExpression = "*",
        consumeThreadNumber = 5)
public class EnhanceLoginLogListener extends EnhanceMessageHandler<LogDTO> implements RocketMQListener<LogDTO> {
