package com.pandama.top.user.biz.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.pandama.top.user.api.pojo.dto.UserSearchDTO;
import com.pandama.top.user.api.pojo.vo.SystemUserInfoVO;
import com.pandama.top.user.api.pojo.vo.UserDetailResultVO;
import com.pandama.top.user.api.pojo.vo.UserLoginVO;
import com.pandama.top.user.api.pojo.vo.UserSearchResultVO;
...
public interface UserMapper extends BaseMapper<SysUser> {
     ...
     * @version: 1.0
     */
    List<UserDetailResultVO> getUserListByDepartmentId(@Param("deptId") Long deptId);
