...
public interface DictMapper extends BaseMapper<SysDict> {
     ...
     * @version: 1.0
     */
    List<SysDict> getDictEntityListByParentId(@Param("dictParentId") Long dictParentId,
                                              @Param("isShowParent") Boolean isShowParent);
     ...
     * @version: 1.0
     */
    List<DictSearchResultVO> listAll();
     ...
     * @version: 1.0
     */
    List<SysDict> getPathById(@Param("dictId") Long dictId);
}
