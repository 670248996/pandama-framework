...
import com.pandama.top.user.api.pojo.vo.LogSearchResultVO;
import com.pandama.top.user.api.pojo.vo.LoginLogExportResultVO;
import com.pandama.top.user.api.pojo.vo.OnlineSearchResultVO;
import com.pandama.top.user.api.pojo.vo.OperateLogExportResultVO;
import com.pandama.top.user.biz.entity.SysLog;
import com.pandama.top.user.api.enums.LoginTypeEnum;
import com.pandama.top.user.biz.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, SysLog> implements LogService, ILogRecordService {
    ...
    @Override
    public PageResultVO<LogSearchResultVO> page(LogSearchDTO dto) {
    ...
    public void exportExcel(LogSearchDTO dto) {
        PageResultVO<LogSearchResultVO> page = this.page(dto);
        // 序号
        AtomicInteger serialNo = new AtomicInteger(1);
        // 登陆日志导出
        if (LogTypeEnum.SYSTEM == dto.getLogType()) {
        ...
        // 操作日志导出
        else if (LogTypeEnum.BUSINESS == dto.getLogType()) {
