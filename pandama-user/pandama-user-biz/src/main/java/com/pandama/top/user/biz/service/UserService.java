...
public interface UserService extends IService<SysUser> {
     ...
     * @version: 1.0
     */
    UserLoginVO getUserLoginInfoByUsername(String username);
     ...
     * @version: 1.0
     */
    UserLoginVO getUserLoginInfoByPhone(String phone);
     ...
     * @version: 1.0
     */
    List<UserDetailResultVO> getUserListByDepartmentId(Long deptId);
