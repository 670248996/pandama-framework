...
import com.pandama.top.file.biz.constants.FileCheckMd5StatusEnum;
import com.pandama.top.file.biz.constants.FileConstant;
import com.pandama.top.file.biz.file.config.FileUploadProperties;
import com.pandama.top.file.biz.file.strategy.RandomAccessUploadStrategy;
...
public class FileUploadUtils {
    ...
    public FileUploadVO upload(FileUploadDTO dto) throws IOException {
        ...
        out.flush();
        FileUtils.close(out);
        redisUtil.hPut(FileConstant.FILE_UPLOAD_STATUS, md5, "true");
    ...
    public FileUploadVO checkFileMd5(FileUploadDTO dto) throws IOException {
        Object uploadProgressObj = redisUtil.hGet(FileConstant.FILE_UPLOAD_STATUS, dto.getMd5()).orElse(null);
        ...
        String value = String.valueOf(redisUtil.get(FileConstant.FILE_MD5_KEY + dto.getMd5()).orElse(""));
