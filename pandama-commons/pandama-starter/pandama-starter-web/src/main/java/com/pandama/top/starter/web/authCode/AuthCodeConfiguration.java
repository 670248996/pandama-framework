...
public class AuthCodeConfiguration {
    ...
    public DefaultKaptcha charAuthCode() {
        ...
        // KAPTCHA_SESSION_KEY
        properties.setProperty(KAPTCHA_SESSION_CONFIG_KEY, "charAuthCode");
        // 验证码文本字符长度 默认为5
    ...
    public DefaultKaptcha mathAuthCode() {
        ...
        // KAPTCHA_SESSION_KEY
        properties.setProperty(KAPTCHA_SESSION_CONFIG_KEY, "mathAuthCode");
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, AuthCodeTextCreator.class.getName());
        // 验证码文本字符间距 默认为2
